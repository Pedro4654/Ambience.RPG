...
<head>
    ...
    <title>Ticket Reaberto - Ambience RPG</title>
</head>
                ...
                <table width="500" cellpadding="0" cellspacing="0" border="0" style="background:#1a1d29;border-radius:8px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.3);">
                    ...
                    <tr>
                        <td style="background:linear-gradient(135deg,#0d5f3a 0%,#0a4a2e 100%);padding:30px 25px;text-align:center;">
                            ...
                            <p style="margin:8px 0 0 0;font-size:13px;color:#b8e6d5;">Nova análise em andamento</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:30px 25px;background:#1a1d29;">
                            ...
                            <p style="margin:0 0 20px 0;font-size:14px;color:#b0b0b0;line-height:1.6;">
                                Seu ticket <strong style="color:#00ff88;">#{{ $ticket->id }}</strong> foi reaberto e está sendo analisado novamente pela nossa equipe.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#0f1a14;border:2px dashed #00ff88;border-radius:8px;margin:20px 0;">
                                <tr>
                                    <td style="padding:25px;text-align:center;">
                                        <div style="font-size:13px;color:#00ff88;margin-bottom:10px;font-weight:600;">TICKET REABERTO</div>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#232631;border-radius:6px;margin:20px 0;">
                                <tr>
                                    <td style="padding:15px 20px;">
                                        <div style="font-size:14px;color:#00ff88;margin-bottom:10px;font-weight:600;">Status Atualizado</div>
                                        <table width="100%" cellpadding="5" cellspacing="0">
                                            <tr>
                                                <td style="font-size:13px;color:#b0b0b0;">Status:</td>
                                                <td style="font-size:13px;color:#00ff88;text-align:right;font-weight:600;">{{ ucfirst($ticket->status) }}</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size:13px;color:#b0b0b0;padding-top:5px;">Reaberto em:</td>
                                ...
                                <tr>
                                    <td style="padding:12px 15px;">
                                        <p style="margin:0;font-size:12px;color:#b0b0b0;line-height:1.6;">
                                            Nossa equipe irá analisar seu caso novamente. Aguarde o retorno em breve.
                                        </p>
                                    </td>
                                </tr>
                            </table>
